...
export default function RankingsPage() {
  ...
  const badgeColumns: ColumnsType<any> = [
    ...
    { title: '描述', dataIndex: 'description', ellipsis: true, width: 200 },
    {
      ...
      dataIndex: 'iconUrl',
      width: 80,
      render: (v: string) => (v ? <img src={v} alt="" style={{ width: 32, height: 32 }} /> : '-'),
    },
    {
      title: '状态',
      dataIndex: 'status',
    ...
    },
    {
      ...
      render: (_, record) => (
        <Button
          ...
          type="link"
          onClick={() => {
            awardForm.setFieldsValue({ badgeId: record.id });
  ...
  const contributionColumns: ColumnsType<any> = [
    ...
    { title: '花朵数', dataIndex: 'flowerCount', width: 80 },
    {
      ...
      dataIndex: 'status',
      width: 80,
      render: (v: string) => <Tag color={v === 'valid' ? 'green' : 'default'}>{v}</Tag>,
    },
                ...
                children: (
                  <>
                    ...
                    <Table
                      ...
                      dataSource={badgesQuery.data?.data?.items ?? []}
              ...
              },
              {
                ...
                children: (
                  <Table
                    ...
                    dataSource={contributionsQuery.data?.data?.items ?? []}
                    loading={contributionsQuery.isLoading}
                    pagination={{
                      current: page,
                      pageSize,
                      total: contributionsQuery.data?.data?.total ?? 0,
